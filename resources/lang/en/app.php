...
//        "steps_bills_payment_description"=>"Click on Pay Now button to initiate the payment process.Provide the bill number .Verify the amount to be paid, click on the Confirm Button.",
        "steps_bills_payment_description"=>"Click on Check Bills button to check your bills. Provide the bill number and click on the Check button.",
        "steps_check_bills"=>"Click on Check Bills button to check your bills. Provide the bill number and click on the Check button.",
        ...
        "fill_the_form_below_to_request_new_connection"=>"Fill the form below to request new connection",
        "in"=>"in",
        "district."=>"District.",
