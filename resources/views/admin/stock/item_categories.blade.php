                    ...
                    <tbody>
                       @foreach($categories as $category)
                           <tr>
                               <td>{{$category->name}}</td>
                               <td>
                                   <span class="text text-{{$category->is_meter ? 'primary':'danger'}}">
                                       {{$category->is_meter ? 'Yes':'No'}}
                                   </span>
                               </td>
                               <td>
                                   <span class="badge badge-{{$category->is_active ? 'primary':'danger'}}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                                ...
                                <input type="checkbox" name="is_meter" id="_is_meter" value="1"> Is Meter
                                <span></span>
                        ...
                        <div class="form-group">
                            <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                                ...
                                <input type="checkbox" name="is_active" id="_is_active" value="1"> Is Active
                                <span></span>
