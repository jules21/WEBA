...
@section('content')
    <div class="form-v4-content mt-5">
        <div class="form-left">
            ...
            <p class="text-1">
                Welcome to our system! We're excited that you're interested in creating an account with us. <br> By creating an account, you'll be able to access exclusive features and content that are not available to non-registered users.
