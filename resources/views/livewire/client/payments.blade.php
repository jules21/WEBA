        ...
        @foreach($payments as $item)
            <div class="card">
                ...
                <div id="collapseOne{{$item->id}}" class="collapse {{ $loop->first?'show':'' }}"
                   ...
                   {{--         <a href="#"
                               class="tw-inline-flex tw-items-center tw-px-4 tw-py-2 tw-text-sm tw-font-medium tw-text-gray-900 tw-bg-white border tw-border tw-border-gray-200 tw-rounded hover:tw-bg-gray-100 hover:tw-text-accent focus:tw-z-10 focus:tw-ring-4 focus:tw-outline-none focus:tw-ring-gray-200 focus:tw-text-blue-700 tw-no-underline">
                                Invoice
